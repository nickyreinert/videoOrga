...
def stream_video(video_id):
    ...
    # The file_path in the database should be the absolute path that the container can see.
    # We assume that the VIDEO_BASE_PATH is the root under which all video files can be found.
